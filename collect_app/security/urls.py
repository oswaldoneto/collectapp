...
from security.api import DocUserPermissionView, DocUserPermissionsView,\
    DocGroupPermissionView, DocGroupPermissionsView
from security.views import GroupCreateView, GroupDeleteView,\
    GroupEditView, UserCreateView, UserEditView, UserDeleteView,\
...
urlpatterns = patterns('',
    ...
    (r'^security/permissions/users/document/(?P<doc_id>\d+)$', login_required(csrf_exempt(DocUserPermissionsView.as_view())),
